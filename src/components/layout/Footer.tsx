    ...
    <footer className="relative overflow-hidden bg-accent text-white">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block rounded-lg bg-white px-5 py-2.5 text-sm font-bold text-brand-dark transition-colors hover:bg-white/90"
            >
              Konsultasi Gratis
            </a>
          </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/30 pt-8 sm:flex-row">
          ...
          <p className="text-sm text-white/80">temanumkmkita.com</p>
        </div>
      </div>
    </footer>
  );
