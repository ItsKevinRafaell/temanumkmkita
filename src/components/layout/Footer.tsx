    ...
    <footer className="bg-accent text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 text-white text-sm font-semibold hover:text-white/80 transition-colors"
            >
          ...
          {/* Layanan */}
          <div>
            <h3 className="font-bold text-white/60 mb-4 text-xs uppercase tracking-widest">Layanan</h3>
          ...
          {/* Perusahaan */}
          <div>
            <h3 className="font-bold text-white/60 mb-4 text-xs uppercase tracking-widest">Perusahaan</h3>
            <ul className="space-y-2.5">
          ...
          {/* Kontak */}
          <div>
            <h3 className="font-bold text-white/60 mb-4 text-xs uppercase tracking-widest">Hubungi Kami</h3>
        ...
        <div className="mt-12 pt-8 border-t border-white/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/50 text-sm">temanumkmkita.com</p>
        </div>
      </div>
    </footer>
  );
