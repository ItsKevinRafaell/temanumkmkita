...
// Lazy load animated cards - only loads framer-motion when needed
const AnimatedHeroCards = dynamic(
  () => import("@/components/sections/AnimatedHeroCards"),
...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      {/* Floating 3D proof cards — desktop only, lazy loaded */}
      <AnimatedHeroCards />
