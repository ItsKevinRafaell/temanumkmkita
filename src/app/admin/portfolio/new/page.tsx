    ...
    <div className="min-h-screen bg-[#fcfaf7]">
      <header className="bg-white border-b border-[#242423]/8 px-6 py-3.5 flex items-center justify-between sticky top-0 z-20 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-bold text-[#242423]">Tambah Portfolio</span>
        </div>
            ...
            {!useCustom ? (
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-shrink-0 text-xs text-[#242423]/40 hover:text-[#242423] underline transition whitespace-nowrap"
                >
                  Custom
                </button>
              </div>
