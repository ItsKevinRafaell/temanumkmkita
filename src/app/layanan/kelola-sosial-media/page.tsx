...
export const metadata: Metadata = {
  ...
  description: "Layanan kelola sosial media untuk UMKM. Konten konsisten, engagement naik, brand kuat di Instagram dan TikTok.",
...
const jsonLd = {
  ...
  description: "Layanan pengelolaan sosial media UMKM — konten, engagement, dan branding di Instagram, TikTok, Facebook.",
};
