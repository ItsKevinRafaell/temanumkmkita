...
const plans = [
  ...
  },
  {
    ...
    features: ["Max. 5 Halaman", "Maps Embed + SEO Dasar", "Google Analytics"],
    cta: "Pilih Pro",
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
              ...
              >
                ...
                <h1 className="mb-4 text-4xl font-extrabold leading-tight text-brand-dark sm:text-5xl">
                  Website Profesional Tanpa
                  <br />
                  <span className="text-accent">Bayar Besar Di Awal.</span>
                </h1>
                <p className="text-lg text-brand-dark/60">
                  Mulai dari Rp 120.000/bulan. Tidak ada biaya setup, tidak ada kontrak tahunan yang
                  menguras modal.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="rounded-md bg-accent/10 px-3 py-1 text-xs font-bold text-accent">
