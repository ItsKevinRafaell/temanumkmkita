...
export const metadata: Metadata = {
  ...
  description: "Optimasi SEO Google Maps untuk UMKM. Bantu bisnis lokal Anda muncul di halaman pertama Google saat pelanggan mencari di area sekitar.",
...
const jsonLd = {
  ...
  description: "Layanan optimasi SEO dan Google Maps untuk membantu bisnis lokal UMKM muncul di pencarian Google.",
};
