...
export const metadata: Metadata = {
  ...
  description:
    "Jasa desain logo profesional untuk UMKM Indonesia. Logo yang merepresentasikan bisnis dengan filosofi dan estetika yang kuat.",
  alternates: { canonical: `${SITE_URL}/layanan/desain-logo` },
  openGraph: {
    title: "Desain Logo untuk UMKM",
    description:
      "Logo profesional yang merepresentasikan bisnis Anda dengan filosofi dan estetika yang kuat.",
...
const jsonLd = {
  ...
  description:
    "Jasa desain logo profesional dengan filosofi merek dan identitas visual yang kuat untuk UMKM.",
};
