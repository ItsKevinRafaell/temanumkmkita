    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/blog"
            className="border border-brand-dark/15 text-brand-dark/70 font-bold px-6 py-2.5 rounded-full text-sm hover:border-accent hover:text-accent transition-colors"
          >
            Kembali
          </Link>
        </div>
